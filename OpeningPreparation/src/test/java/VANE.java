...
public class VANE {
    ...
    private static BigDecimal[] VANETest(TrustAuthority ta, List<String> urls) throws Exception {
        ...
        return csp.LR(res, n, org);
    }

    public static void updateByAddDOs(BigDecimal[] a, TrustAuthority ta, List<String> urls) throws Exception {
        BigDecimal[] copyA = Arrays.copyOf(a, a.length);
        System.out.println("添加至" + urls.size() + "个 DataOwner");
        System.out.println("更新秘钥:");
        // keyGenerate 后得到 PP、SK_DO 和 SK_CSP
        HashMap<String, Keys[]> keyGenerate = ta.updateByAddDOs(urls.size());
        ...
        BigDecimal[] updateA = csp.LR(res, n, a);
