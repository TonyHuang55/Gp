...
public class LinearRegressionUtils {
    public static void LR(BigInteger[][] M) {
        ...
        BigDecimal a = new BigDecimal("0.1"),
                a0 = new BigDecimal("0.1"),
                a1 = new BigDecimal("0.1"),
                a2 = new BigDecimal("0.1"),
                a3 = new BigDecimal("0.1"),
                a4 = new BigDecimal("0.1"),
                a5 = new BigDecimal("0.1"),
                a6 = new BigDecimal("0.1"),
                a7 = new BigDecimal("0.1"),
                a8 = new BigDecimal("0.1"),
                a9 = new BigDecimal("0.1"),
                a10 = new BigDecimal("0.1");
